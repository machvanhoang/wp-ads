      ...
      <div class="row">
        <div class="col-md-4">
          <div class="footer-logo">
            <a href="">
              <img src="https://bmdsolutions.vn/wp-content/uploads/2020/02/header_logo.png" alt="">
            </a>
          </div>
          <div class="footer-infomations">
            <div class="footer-info">
              ...
              <div class="items-f">
                ...
                <div class="items-info">
                  <a href="maito:contact@haweb.vn" target="blank" title="Email: contact@haweb.vn">Email:
                    contact@haweb.vn</a>
                </div>
              </div>
              <div class="items-f">
                ...
                <div class="items-info">
                  <a href="https://haweb.vn" title="Haweb.vn">Website: www.haweb.vn</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4">
          ...
          <ul class="list-footer">
            ...
            <li>
              <a href="" title="Thỏa thuận sử dụng dịch vụ">
                Thỏa thuận sử dụng dịch vụ </a>
            </li>
            <li>
  ...
  <div class="footer-copyright">
    <div class="c-container">
      <div class="flex justify-center align-center">
        <p>&copy; Copyright <a href="">hoanganhweb.com</a> 2023. All Rights Reserved</p>
      </div>
    </div>
  </div>
</footer>
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/app.js">
